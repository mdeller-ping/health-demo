...
<body>
  ...
  <div class="jumbotron jumbotron-fluid mb-n1">
    <div class="container">
      <h1 class="display-4">New Consent Record</h1>
      <p class="lead">The buttons below will allow you to create a new consent record, either for a Physician or a Spouse.  The system supports many different types of consents, beyond this simple example.</p>
    </div>
  </div>
  <!-- /hero banner -->
