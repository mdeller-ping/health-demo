...
<?php } ?>
  ...
  <div class="jumbotron jumbotron-fluid mb-n1">
    <div class="container">
      <h1 class="display-4">Virtual Care Enablement</h1>
      <p class="lead">The COVID-19 pandemic is driving a massive increase in telehealth services as a safe way to triage symptoms. The unprecedented demand for services coupled with the risk of viral transmission has made traditional healthcare delivery more difficult.</p> 
    </div>
  </div>
  <!-- /hero banner -->
